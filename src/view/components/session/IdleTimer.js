/**
 * @prettier
 * @description: reactIdleTimer component
 * @see https://github.com/supremetechnopriest/react-idle-timer
...
/**
 * IdleTimer component that detects when your user is idle
 * @class IdleTimer
 * @public
 */
export default class IdleTimer extends React.Component {
  ...
  _handleEvent = (e) => {
    ...
    this.setState({
      ...
      pageX: e.pageX, // update mouse coordinates
      pageY: e.pageY
    })
