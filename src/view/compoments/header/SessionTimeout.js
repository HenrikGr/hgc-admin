...
class SessionTimeout extends React.Component {
  ...
  static propTypes = {
    ...
    /**
     * On refresh function, can be used to display a dialog to extend the session
     */
    onRefresh: PropTypes.func,

    /**
     * On stop function, can be used to redirect to a login page
     */
