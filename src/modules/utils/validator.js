...
validator.types.isPassword = {
  ...
  instructions:"Value must be 6-20 long and at least one numeric, one uppercase and one lowercase"
};
...
validator.types.isAlphaNum = {
  ...
  instructions:"Value can only contain characters and numbers, no special symbols"
};
